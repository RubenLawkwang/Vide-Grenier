...
{
    public partial class usermanageproduct : System.Web.UI.Page
    {
...
.ConnectionString;
            ...
            private void BindProductdata()
        {
            ...
            cmd.Connection = con;
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "SELECT * FROM tblProduct Where Users_user_id = '" + Session["User_id"] + "'";
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            //Create a DataTable
            DataTable dt = new DataTable();
        ...
        protected void btndelete_Click2(object sender, EventArgs e)
        {
            ...
            if (IsDeleted)
            {
                lblMsg.Text = txtPname.Text + " product deletedsuccessfully!";
                lblMsg.ForeColor = System.Drawing.Color.Green;
                //Refresh the GridView by calling the BindMovieData()
                BindProductdata();
