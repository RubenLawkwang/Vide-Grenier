...
WebConfigurationManager.ConnectionStrings["vgrenierdb"].ConnectionString;
        ...
        void getActiveUsers()
        {
            ...
            cmd.CommandText = "Select User_id, U_fname, U_lname, U_username,U_profile_img from tblUsers where U_status = 1";
            cmd.Connection = con;
        ...
        protected void lnkblock_Click(object sender, EventArgs e)
        {
            ...
            ucmd.CommandText = "update tblUsers set U_status='0' where User_id = " + uid;
            ucmd.Connection = con;
